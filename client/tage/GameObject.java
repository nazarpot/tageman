...
public class GameObject
{
	...
	*/
	...
	/** rotates object on its y-axis */
	public void yaw(float direction) {
		Matrix4f oldRotation, newRotation, rotAroundAvatarUp; 
    	Vector3f oldUp;

        oldRotation = new Matrix4f(this.getWorldRotation());
        oldUp = new Vector3f (this.getWorldUpVector());
        rotAroundAvatarUp = new Matrix4f().rotation(0.01f * direction, oldUp);
